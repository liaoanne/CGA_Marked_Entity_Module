...
if($_SESSION['role_id'] == 1){
	...
	echo "<li><a href='post_notices.php?course_id=".$_SESSION['course_id']."'><b><font color=black>Manage Courses</b></a></li>";
...
elseif($_SESSION['role_id'] == 2){
	...
	echo "<li><a href='manage_students.php?course_id=".$_SESSION['course_id']."'><b><font color=black>Manage Students</b></a></li>";
	echo "<li><a href='manage_ta.php?course_id=".$_SESSION['course_id']."'><b><font color=black>Manage Teaching Assistants</b></a></li>";
